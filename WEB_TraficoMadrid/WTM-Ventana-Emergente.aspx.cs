...
{
    public partial class WTM_Ventana_Emergente : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "myScript", "JS_Ventana_Emergente('" + strOrigenX + "','" + strOrigenY + "','" + strDestinoX + "','" + strDestinoY + "','" + strIdLine + "','" + strName_First + "','" + strName_End + "','" + strMinutos_Estim_CON_Predic_Tiempo + "','" + iHora + "','" + Convert.ToInt32(strPrevisionTiempo) + "');", true);
