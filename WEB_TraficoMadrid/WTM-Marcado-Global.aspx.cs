...
{
    public partial class WTM_Marcado_Global : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            //Para pruebas nos aseguramos el día correcto, solamente hay que comentar las dos sigueintes lineas para que todo funcione correctamente
            ...
            where Convert.ToInt32(x.Field<string>("Tiempo_Por_Hora")) == iHora
                         select new
                         {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "myScript", "JS_Marcado_Global('" + strOrigenX + "','" + strOrigenY + "','" + strDestinoX + "','" + strDestinoY + "','" + strIdLine + "','" + strName_First + "','" + strName_End + "','" + strMinutos_Estim_CON_Predic_Tiempo + "','" + iHora + "','" + Convert.ToInt32(strPrevisionTiempo) + "');", true);
        }
